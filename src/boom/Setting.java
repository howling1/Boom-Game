...
public class Setting extends JDialog implements ActionListener, KeyListener,
    ...
    public void addPart() {
        ...
        font = new Font("宋体", 1, 14);

        radio = new JRadioButton[4];
        str1 = new String[] { "10 booms", "40 booms", "99 booms", "Customize" };
        ...
        label = new JLabel[9];
        str = new String[] { "Easy", "9*9 Net", "Middle", "16*16 Net", "Hard",
                "16*30Net", "Height(9-24):", "Width(9-40):", "Number of Booms(0-900):" };
